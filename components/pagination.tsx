...
function PaginationInner({ page, pages, total }: { page: number; pages: number; total: number }) {
    ...
    <div className="flex flex-col items-center gap-3 py-6">
      <div className="flex items-center gap-1">
        <Link
          ...
          className={cn(buttonVariants({ variant: "outline", size: "icon" }), page <= 1 && "pointer-events-none opacity-50")}
        >
        ...
        <Link
          ...
          className={cn(buttonVariants({ variant: "outline", size: "icon" }), page >= pages && "pointer-events-none opacity-50")}
        >
...
export function AppPagination(props: { page: number; pages: number; total: number }) {
  return (
